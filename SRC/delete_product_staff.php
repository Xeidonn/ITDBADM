<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm_delete'])) {
        // Delete related entries from order_items table first
        $delete_order_items_sql = "DELETE FROM order_items WHERE product_id = ?";
        $delete_order_items_stmt = $conn->prepare($delete_order_items_sql);
        $delete_order_items_stmt->bind_param("i", $product_id);
